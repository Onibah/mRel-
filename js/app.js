 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".page-suggestions__slider")) new core(".page-suggestions__slider", {
            ...
            if (window.matchMedia("(max-width: 632.98px)").matches) if (document.querySelector(".write-about-us-page__slider")) new core(".write-about-us-page__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "1.2",
